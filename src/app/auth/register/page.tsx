    ...
    <div className="w-full max-w-sm px-4 py-10 sm:py-16">
      <div className="rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-6 sm:p-8 shadow-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-neutral-100">Join Iwacu Chef</h1>
          <p className="mt-1.5 text-sm text-neutral-500 dark:text-neutral-400">Create your account to get started</p>
        </div>
        <RegisterForm />
        <p className="mt-6 text-center text-sm text-neutral-400 dark:text-neutral-500">
          Already have an account?{" "}
          <Link href="/auth/login" className="text-brand-primary hover:text-brand-primary-hover font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>

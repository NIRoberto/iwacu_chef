...
export function ChefProfile({ chef }: ChefProfileProps) {
  return (
    <div>
      <div className="aspect-[3/1] rounded-2xl bg-neutral-100 overflow-hidden mb-6">
        <div
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-5">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-3xl font-bold text-neutral-900">{chef.name}</h1>
          <p className="text-lg text-neutral-400 mt-1">{chef.title}</p>
      ...
      <div className="mt-8">
        <h2 className="text-xl font-semibold text-neutral-900 mb-3">About {chef.name}</h2>
        <p className="text-neutral-500 leading-relaxed whitespace-pre-line">{chef.story}</p>
      </div>
    </div>
  )
}

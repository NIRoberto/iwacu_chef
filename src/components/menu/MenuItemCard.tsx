...
export function MenuItemCard({ item }: MenuItemCardProps) {
  ...
  return (
    <article className="flex gap-4 rounded-xl border border-neutral-100 bg-white p-4 transition-shadow hover:shadow-sm">
      <div className="w-24 h-24 shrink-0 rounded-lg bg-neutral-100 overflow-hidden">
        <div
